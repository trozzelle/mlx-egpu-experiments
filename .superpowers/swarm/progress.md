...
| Wave A / F1 persistent warm worker | In progress | Supervisor integration | B0 | `f1-contract-freeze.md`, F1 RED/GREEN reports | Task set 1 Done; task set 2 focused suite 71 passed; task set 3 focused suite 27 passed after persistent all-layer/embedding/N=0/budget fixes. Final re-review and task set 4 integration remain. | — |
...
| Wave A / P3 Kernel Packs | In progress | P3 runtime/offline integration | B0; G0 for final migration | `p3-contract-freeze.md`; P3 RED/GREEN reports | Task set 1 Done; task set 2 runtime focused suite 11 passed; task set 3 offline suite is in final residual verification. | Task set 5 waits for G0. |
| Wave A / Q1 Qwen contract/oracle | In progress | Q1Oracle / Q1ShapeMap | B0 | Q1 identity/tensor/hybrid/shape reports | Task sets 1–3 Done; tensor task-set command 41 passed, hybrid task-set command 46 passed, task set 5 shape map complete; task set 4 fixture implementation in progress. | Q1 promotion remains blocked by unavailable immutable base-model revision; native execution remains downstream of F6. |
