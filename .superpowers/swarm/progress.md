...
- **Remaining blocker**: mlx safetensors Llama 3.2 1B (same weights) NOT present anywhere — must be downloaded (HF_TOKEN/HF_HOME are set). Parity RUN (P==R) waits for that download. Harness code is complete and importable.
