...
- `docs/superpowers/plans/2026-08-17-cp-mec-rs64-exception-grounding.md:13-25` preserves the shared work boundary, current blocker, no behavior fix before a reviewed one-field lane, forbidden-work list, and executor validation restrictions.
- `docs/superpowers/plans/2026-08-17-cp-mec-rs64-exception-grounding.md:34-38` rejects immediate one-field fixes and BAR2/GDC/S2A/MQD reopening, selecting source-grounding followed by diagnostic-only context readback.
- `docs/tasks/amdev-doorbell-delivery/phase-9-cp-mec-rs64-source-grounding.md:4-13` preserves the parent plan, current reviewed blocker, shared work boundary, selected lane, and forbidden-work list.
