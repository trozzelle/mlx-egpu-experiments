...
- RED: `${PY} -m pytest tests/native_r9700/test_prefill.py::test_prefill_cli_rejects_output_log_alias_conflict_without_generic_side_effects -q`
...
- GREEN: `${PY} -m pytest tests/native_r9700/test_prefill.py::test_prefill_cli_rejects_output_log_alias_conflict_without_generic_side_effects -q`
