...
- Full native regression after fixture regeneration: `${HOME}/.pyenv/versions/3.12.8/bin/python3 -m pytest tests/native_r9700 -q` exited 0 with `268 passed, 2 warnings in 357.98s`; raw output `artifact://2699`.
- Review metadata RED/GREEN:
  - RED: `${HOME}/.pyenv/versions/3.12.8/bin/python3 -m pytest tests/native_r9700/test_ref_fixtures.py::test_layer_trace_fixtures_schema_shape_dtype -q` failed with `KeyError: 'additional_trace_slices'` before generator/schema update.
