...
```sh
${PY} -m pytest tests/native_r9700/test_ref_fixtures.py -k 'mlp_down_proj_full_inner and cols448_512' -q
```
...
```sh
${PY} -m pytest tests/native_r9700/test_runtime_contract.py -k 'mlp_down_cols448_512_embedded_operands_use_kernel_layouts or mlp_down_full_inner_to_cols448_512_chain' -q
```
...
```sh
${PY} -m pytest tests/native_r9700/test_ref_fixtures.py -k 'schema_json_matches_disk_digests or all_fixture_files_small_enough' -q
```

Result: `2 passed, 68 deselected in 0.04s`.

```sh
${PY} -m pytest tests/native_r9700/test_runtime_contract.py -k 'help_lists_dry_run_kernel_proof_and_transfer_proof_modes or mlp_down_cols448_512_embedded_operands_use_kernel_layouts or mlp_down_full_inner_to_cols448_512_chain' -q
```
...
```sh
${PY} -m pytest tests/native_r9700/test_ref_fixtures.py -k 'mlp_down_proj_full_inner and cols448_512 or schema_json_matches_disk_digests or all_fixture_files_small_enough' -q
${PY} -m pytest tests/native_r9700/test_runtime_contract.py -k 'help_lists_dry_run_kernel_proof_and_transfer_proof_modes or mlp_down_cols448_512_embedded_operands_use_kernel_layouts or mlp_down_full_inner_to_cols448_512_chain' -q
