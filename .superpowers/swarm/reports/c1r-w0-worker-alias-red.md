...
- RED: `${HOME}/.pyenv/versions/3.12.8/bin/python3 -m pytest tests/native_r9700/test_runtime_contract.py::test_native_worker_blocks_lexically_distinct_output_and_log_aliases_before_runner -q`
...
- GREEN: `${HOME}/.pyenv/versions/3.12.8/bin/python3 -m pytest tests/native_r9700/test_runtime_contract.py::test_native_worker_blocks_lexically_distinct_output_and_log_aliases_before_runner -q`
