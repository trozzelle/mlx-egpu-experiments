...
**Evidence worktree:** `<repo-root>` (`feature/r9700-products-wave-a`)

## Changed files

Only the two new DEXT-owned resource-table files were historically added in the former TinyGPU source tree:
