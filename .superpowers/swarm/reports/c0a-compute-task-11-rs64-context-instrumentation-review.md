...
## review_evidence
- Scope and guardrails: `docs/tasks/amdev-doorbell-delivery/phase-9-cp-mec-rs64-source-grounding.md:9-13` selects `rs64_exception_context_diagnostic`, allows only source-grounded RS64 context readbacks, and forbids BAR2, GDC/S2A, CP MEC doorbell range, PM4, scheduler, retry, AQL, fallback, allocator/runtime framework, and C1/C2/C3 changes.
