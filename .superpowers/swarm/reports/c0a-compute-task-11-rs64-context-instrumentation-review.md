...
- Source-grounded register names/offsets: `experiments/native-r9700-runtime/native_amdev_transfer_probe.cpp:2829-2859` adds only the requested CP/MEC RS64 context `RegDef` constants with offsets `10504`, `10540`-`10544`, `10552`, and `10554`-`10569`, all segment `1`; `<tinygrad-checkout>/tinygrad/runtime/autogen/am/regs.py:1817-1818`, `:6096-6100`, and `:6107-6123` define the same names, offsets, and base index.
