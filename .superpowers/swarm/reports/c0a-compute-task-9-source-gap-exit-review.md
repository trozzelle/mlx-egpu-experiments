...
- Phase document preserves the boundary: it records user approval for diagnostic-only HQD/PQ despite the semantic gap and no route/range/BAR2 authorization at `docs/tasks/amdev-doorbell-delivery/phase-6-doorbell-blocker-resolution.md:6-7`; its orchestration and coordination risks keep route/range/BAR2/PM4/fallback/framework/C1/C2/C3 work unauthorized unless a later decision matrix selects one lane at `docs/tasks/amdev-doorbell-delivery/phase-6-doorbell-blocker-resolution.md:18-21`; Task set 1 records no source/tests/hardware/route/range/BAR2 changes and only HQD/PQ diagnostic authorization at `docs/tasks/amdev-doorbell-delivery/phase-6-doorbell-blocker-resolution.md:43-51`; review gates and handoff notes preserve source-gap review and fix restrictions at `docs/tasks/amdev-doorbell-delivery/phase-6-doorbell-blocker-resolution.md:168-177`.
