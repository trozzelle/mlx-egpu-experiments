...
MIT source provenance is recorded in the interface and implementation comments from tinygrad AMDev at `<tinygrad-checkout>/tinygrad/runtime/support/am/amdev.py:202-205,279-320` and its allocator at `<tinygrad-checkout>/tinygrad/runtime/support/memory.py:175-184`.
