...
review_evidence:
- Phase 8 scope: `docs/tasks/amdev-doorbell-delivery/phase-8-cp-mec-visibility-diagnostic.md:10-40` selects `cp_mec_visibility_diagnostic`, limits next work to CP/MEC status/source readbacks only, and forbids route/range/BAR2/PM4/scheduler/retry/fallback changes.
