...
Command:
```sh
${HOME}/.pyenv/versions/3.12.8/bin/python3 -m pytest tests/native_r9700/test_ref_fixtures.py::test_layer_trace_fixtures_schema_shape_dtype tests/native_r9700/test_ref_fixtures.py::test_layer0_attention_score_raw_head0_tokens0_5_fixture_matches_rope_dot_oracle tests/native_r9700/test_ref_fixtures.py::test_layer0_attention_score_raw_head0_tokens0_5_fixture_matches_scaled_trace_cells tests/native_r9700/test_runtime_contract.py::test_help_lists_dry_run_kernel_proof_and_transfer_proof_modes tests/native_r9700/test_runtime_contract.py::test_primitive_chain_proof_wraps_supplied_bridge_and_logs_layer0_attention_score_raw_head0_tokens0_5_chain tests/native_r9700/test_runtime_contract.py::test_primitive_chain_proof_rejects_missing_attention_score_raw_source_arrays_marker -q
```
