...
- `python3 -c "import tinygrad; print(tinygrad.__file__)"` →
  `/Users/torinrozzelle/Development/ml/tools/tinygrad/tinygrad/__init__.py`. tinygrad is installed
  from a **local checkout** at `/Users/torinrozzelle/Development/ml/tools/tinygrad/` (not site-packages).
...
JITBEAM=2 DEV=AMD python3 -m tinygrad.llm \
  --model /Users/torinrozzelle/Library/Caches/tinygrad/downloads/3cdb17618469285f97f176c434543c9c \
  --max_context 1024
