...
EXPECTED_AM_VM_PAGE_TABLE_PLAN_LINES = (
    ...
    "vram_va: 0x0000200000100000",
    "readback_va: 0x0000200000101000",
    ...
    "staging_ptb_index: 0",
    "vram_ptb_index: 256",
    "readback_ptb_index: 257",
    "boot_arena_size: 0x02000000",
    "ptable_arena_base: 0x02000000",
    "fixed_vram_buffer_paddr: 0x0000000006000000",
    "sdma_control_va: 0x0000200000102000",
    "sdma_control_ptb_index: 258",
    "kernel_output_va: 0x0000200000103000",
    "kernel_output_ptb_index: 259",
    "kernel_code_va: 0x0000200000104000",
    "kernel_code_ptb_index: 260",
    "kernel_kernargs_va: 0x0000200000105000",
    "kernel_kernargs_ptb_index: 261",
    "compute_ring_va: 0x0000200000106000",
    "compute_ring_ptb_index: 262",
    "compute_rptr_wptr_timeline_va: 0x000020000010e000",
    "compute_rptr_wptr_timeline_ptb_index: 270",
    "compute_eop_va: 0x000020000010f000",
    "compute_eop_ptb_index: 271",
    "status: pass",
)
...
EXPECTED_SDMA_RING_SETUP_LINES = (
    ...
    "ring_va: 0x0000200000102000",
    "ring_size_bytes: 2048",
    "ring_size_field: 9",
    "rptr_va: 0x0000200000102800",
    "wptr_va: 0x0000200000102808",
    "fence_va: 0x0000200000102810",
    "doorbell_index: 256",
...
EXPECTED_SDMA_FENCE_PACKET_ENCODING_LINES = (
    ...
    "fence_value: 1",
    "fence_address: 0x0000200000102810",
    "fence_address_le: 1028100000200000",
    "packet_hex: 05000300102810000020000001000000",
    "status: pass",
)
...
EXPECTED_KERNEL_PROOF_CONTRACT_LINES = (
    ...
    "compute_ring_gpu_va: 0x0000200000106000",
    "compute_ring_size_bytes: 32768",
    "compute_rptr_gpu_va: 0x000020000010e000",
    "compute_wptr_gpu_va: 0x000020000010e008",
    "compute_timeline_gpu_va: 0x000020000010e010",
    "compute_eop_gpu_va: 0x000020000010f000",
...
EXPECTED_COMPUTE_VM_LAYOUT_LINES = (
    ...
    "kernel_input_vram_va: 0x0000200000100000",
    "kernel_output_vram_va: 0x0000200000103000",
    "kernel_code_vram_va: 0x0000200000104000",
    "kernel_kernargs_va: 0x0000200000105000",
    "compute_ring_va: 0x0000200000106000",
    "compute_rptr_va: 0x000020000010e000",
    "compute_wptr_va: 0x000020000010e008",
    "compute_timeline_va: 0x000020000010e010",
    "compute_eop_va: 0x000020000010f000",
    "compute_control_requested_size: 40960",
    "compute_control_queue_cpu_offset: 0",
    "compute_control_kernargs_cpu_offset: 4096",
    "kernel_input_ptb_index: 256",
    "kernel_output_ptb_index: 259",
    "kernel_code_ptb_index: 260",
    "kernel_kernargs_ptb_index: 261",
    "compute_ring_ptb_index: 262",
...
EXPECTED_COMPUTE_MQD_ENCODING_LINES = (
    ...
    "mqd_cp_hqd_pq_base_lo: 0x00001060",
    "mqd_cp_hqd_pq_base_hi: 0x00000020",
    "mqd_cp_hqd_pq_wptr_poll_addr_lo: 0x0010e008",
    "mqd_cp_hqd_pq_wptr_poll_addr_hi: 0x00002000",
    "mqd_cp_hqd_eop_base_addr_lo: 0x000010f0",
    "mqd_cp_hqd_eop_base_addr_hi: 0x00000020",
    "mqd_cp_hqd_hq_status0: 0x20004000",
    "mqd_compute_user_data_0: 0x00105000",
