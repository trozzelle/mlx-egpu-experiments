...
- Shared contracts/artifacts: `logs/c0b-native-amdev-sdma-transfer.log`, `.superpowers/swarm/progress.md`, `docs/tasks/native-r9700-producer/README.md`, `phase-c0a-macos-egpu-runtime-focus.md`, `phase-c0b-native-amdev-sdma-transfer.md`.
