...
## Source grounding
- `docs/superpowers/plans/2026-08-21-native-r9700-product-worker-rearchitecture.md`, Wave 1 Tasks 3–6.
- `docs/tasks/native-r9700-producer/phase-c1-c2-r9700-recovery-plan.md:121-150`: reusable memory/transfer manager and native primitive requirements.
