...
## Source grounding
- Source plan read: `docs/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 1-21 for goal, architecture, and global constraints.
...
### Source refs
- Plan Task 1: `docs/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 38-108.
...
### Source refs
- Plan Task 2: `docs/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 112-230.
