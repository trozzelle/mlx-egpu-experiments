...
**Design spec:** `docs/superpowers/specs/2026-08-24-native-prefill-compute-side-optimization-design.md`
...
- Do not sweep the pre-existing archive-reorganization changes under `.superpowers/swarm/` and `docs/tasks/native-r9700-producer/` into task commits.
...
**Files:**
- Read: `docs/superpowers/specs/2026-08-24-native-prefill-compute-side-optimization-design.md`
- Read: `docs/superpowers/plans/2026-08-24-native-prefill-compute-batching-inpage-kernargs.md`
...
- Modify: `docs/tasks/native-r9700-producer/README.md` (current performance/status only)
