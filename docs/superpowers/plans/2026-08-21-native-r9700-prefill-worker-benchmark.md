...
> **Superseded implementation mechanics:** Tasks 2–3 reference the retired `native_r9700/c1_primitive_bridge.cpp` source-as-data proof lane. Do not execute those bridge-dependent steps. Use `docs/superpowers/plans/2026-08-21-native-r9700-product-worker-rearchitecture.md` and its `phase-c1r-product-worker-*.md` task packets for the C1R product-worker path. The goal, acceptance gates, C2R dependency, and benchmark-after-C2 sequence remain active.
...
- Modify: `docs/tasks/native-r9700-producer/phase-c2-serving-integration.md`
