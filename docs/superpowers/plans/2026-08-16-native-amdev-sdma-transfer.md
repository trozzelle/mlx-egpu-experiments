...
- Create `docs/tasks/native-r9700-producer/phase-c0b-native-amdev-sdma-transfer.md`: executable task ledger for this phase.
...
- Create/update: `docs/tasks/native-r9700-producer/phase-c0b-native-amdev-sdma-transfer.md`
...
**Interfaces:**
- Consumes: native boundary spec `docs/superpowers/specs/2026-08-16-native-amdev-sdma-boundary-design.md`.
