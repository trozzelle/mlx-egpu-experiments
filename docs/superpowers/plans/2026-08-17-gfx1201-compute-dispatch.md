...
- Update `.superpowers/swarm/progress.md`, `.superpowers/swarm/native-r9700-producer-supervisor.md`, and `docs/tasks/native-r9700-producer/phase-c0a-macos-egpu-runtime-focus.md` during execution.
