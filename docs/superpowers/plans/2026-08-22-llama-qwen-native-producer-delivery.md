...
1. Read the first unblocked task row from `docs/tasks/native-r9700-producer/phase-c1r-native-llama-delivery.md`, `phase-qwen3-8-native-text-delivery.md`, and `phase-native-producer-swarm-integration.md`.
