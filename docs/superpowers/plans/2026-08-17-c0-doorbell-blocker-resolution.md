...
- Create: `docs/tasks/amdev-doorbell-delivery/phase-6-doorbell-blocker-resolution.md`
...
- Modify: `docs/tasks/amdev-doorbell-delivery/phase-6-doorbell-blocker-resolution.md`
...
Create `docs/tasks/amdev-doorbell-delivery/phase-6-doorbell-blocker-resolution.md` with a progress ledger containing these rows:
...
next_task_doc: docs/tasks/amdev-doorbell-delivery/phase-7-<selected-lane>.md
```
