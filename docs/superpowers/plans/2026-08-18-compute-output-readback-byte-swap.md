...
- Docs (supervisor, after review): `.superpowers/swarm/progress.md` C0A Compute 23 row; `docs/tasks/native-r9700-producer/phase-c0a-macos-egpu-runtime-focus.md` and `docs/tasks/native-r9700-producer/validation-commands.md` reflect the C0A23 diagnostic.
...
Plan complete and saved to `docs/superpowers/plans/2026-08-18-compute-output-readback-byte-swap.md`.
