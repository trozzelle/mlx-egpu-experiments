...
## Source grounding
- `docs/archive/superpowers/plans/2026-08-21-native-r9700-product-worker-rearchitecture.md`, Wave 2 Tasks 7–8.
- `docs/archive/tasks/native-r9700-producer/phase-c1-c2-r9700-recovery-plan.md:152-164`: layer-0 must compose hardware primitives in model order and compare K/V/hidden state to the CPU oracle.
