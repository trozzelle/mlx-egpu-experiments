...
## Source grounding
- Source plan: `docs/archive/superpowers/plans/2026-08-17-c0-doorbell-blocker-resolution.md`.
- Prior phase: `docs/archive/tasks/amdev-doorbell-delivery/phase-5-doorbell-source-gap-resolution.md`.
...
### Source refs
- Plan Task 1: `docs/archive/superpowers/plans/2026-08-17-c0-doorbell-blocker-resolution.md:52-118`.
...
### Source refs
- Plan Task 2: `docs/archive/superpowers/plans/2026-08-17-c0-doorbell-blocker-resolution.md:122-192`.
...
### Source refs
- Plan Task 3: `docs/archive/superpowers/plans/2026-08-17-c0-doorbell-blocker-resolution.md:196-364`.
...
### Source refs
- Plan Task 4: `docs/archive/superpowers/plans/2026-08-17-c0-doorbell-blocker-resolution.md:368-419`.
...
### Source refs
- Plan Task 5: `docs/archive/superpowers/plans/2026-08-17-c0-doorbell-blocker-resolution.md:421-464`.
...
### Source refs
- Plan Task 7 and final verification: `docs/archive/superpowers/plans/2026-08-17-c0-doorbell-blocker-resolution.md:704-769`.
...
- If the consumption classification selects a fix lane, write the next phase doc `docs/archive/tasks/amdev-doorbell-delivery/phase-7-<selected-lane>.md` before source changes.
