...
## Source grounding
- Source plan read: `docs/archive/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 696-728 for the added promotion gate after the diagnostic checkpoint.
- Prior handoff read: `docs/archive/tasks/amdev-doorbell-delivery/phase-3-review-ledger-checkpoint.md` lines 162-168.
...
### Source refs
- Promotion gate: `docs/archive/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 702-705 and 717.
...
### Source refs
- Promotion gate: `docs/archive/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 706-709 and 718.
- Diagnostic report: `.superpowers/swarm/reports/c0a-compute-task-6-doorbell-delivery.md` lines 25-38.
...
### Source refs
- Promotion gate: `docs/archive/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 710-713 and 719.
...
### Source refs
- Promotion gate lane-selection rules: `docs/archive/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 715-728.
- Phase 3 handoff: `docs/archive/tasks/amdev-doorbell-delivery/phase-3-review-ledger-checkpoint.md` lines 162-168.
...
### Source refs
- Promotion gate and non-goal boundary: `docs/archive/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 698-728.
- Consolidated report from Task set 4: `.superpowers/swarm/reports/c0a-compute-task-7-doorbell-source-grounding.md`.
- Prior review quality bar from `docs/archive/tasks/amdev-doorbell-delivery/phase-3-review-ledger-checkpoint.md` lines 31-65.
