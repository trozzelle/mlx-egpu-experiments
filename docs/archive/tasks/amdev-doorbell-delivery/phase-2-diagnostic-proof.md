...
## Source grounding
- Source plan read: `docs/archive/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 234-482 for read-only `--kernel-proof` snapshots.
...
### Source refs
- Plan Task 3: `docs/archive/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 234-482.
...
### Source refs
- Plan Task 4: `docs/archive/superpowers/plans/2026-08-17-mec-doorbell-delivery.md` lines 486-571.
