...
## Source grounding
- Source plan read: `docs/archive/superpowers/plans/2026-08-17-gfx1201-compute-dispatch.md` lines 1-23, 783-900, 904-909.
- Existing C0A ledger read: `docs/archive/tasks/native-r9700-producer/phase-c0a-macos-egpu-runtime-focus.md` lines 30-38.
...
- Shared contracts/artifacts: `.superpowers/swarm/reports/c0a-compute-split-decision.md`, `.superpowers/swarm/reports/c0a-compute-final-review.md`, `.superpowers/swarm/progress.md`, `.superpowers/swarm/native-r9700-producer-supervisor.md`, `docs/archive/tasks/native-r9700-producer/phase-c0a-macos-egpu-runtime-focus.md`, `docs/tasks/native-r9700-producer/validation-commands.md`.
...
### Source refs
- Plan Task 7: `docs/archive/superpowers/plans/2026-08-17-gfx1201-compute-dispatch.md` lines 783-841.
...
### Source refs
- Plan Task 8 Steps 1-2: `docs/archive/superpowers/plans/2026-08-17-gfx1201-compute-dispatch.md` lines 845-870.
...
### Source refs
- Plan Task 8 Steps 3-5: `docs/archive/superpowers/plans/2026-08-17-gfx1201-compute-dispatch.md` lines 871-900.
- Existing C0A ledger: `docs/archive/tasks/native-r9700-producer/phase-c0a-macos-egpu-runtime-focus.md` lines 30-38.
