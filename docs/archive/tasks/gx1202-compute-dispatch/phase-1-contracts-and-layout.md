...
## Source grounding
- Source plan read: `docs/archive/superpowers/plans/2026-08-17-gfx1201-compute-dispatch.md` lines 1-23, 47-61, 65-352.
- Existing C0A state read: `docs/archive/tasks/native-r9700-producer/phase-c0a-macos-egpu-runtime-focus.md` lines 30-38.
...
### Source refs
- Plan Task 1: `docs/archive/superpowers/plans/2026-08-17-gfx1201-compute-dispatch.md` lines 65-243.
...
### Source refs
- Plan Task 2: `docs/archive/superpowers/plans/2026-08-17-gfx1201-compute-dispatch.md` lines 247-352.
