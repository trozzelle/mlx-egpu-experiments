...
## Source grounding
- Source plan read: `docs/archive/superpowers/plans/2026-08-17-gfx1201-compute-dispatch.md` lines 1-23, 47-61, 488-600.
- Existing C0A state read: `docs/archive/tasks/native-r9700-producer/phase-c0a-macos-egpu-runtime-focus.md` lines 34-38.
...
### Source refs
- Plan Task 4 interfaces and Step 1: `docs/archive/superpowers/plans/2026-08-17-gfx1201-compute-dispatch.md` lines 488-517.
...
### Source refs
- Plan Task 4 Steps 2-3: `docs/archive/superpowers/plans/2026-08-17-gfx1201-compute-dispatch.md` lines 518-560.
...
### Source refs
- Plan Task 4 Steps 4-7: `docs/archive/superpowers/plans/2026-08-17-gfx1201-compute-dispatch.md` lines 562-600.
